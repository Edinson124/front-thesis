...
const columns = [
  ...
  { field: 'bloodBankNameOrigin', header: 'Banco de Sangre' },
  ...
  <div class="card">
    ...
    <div>
      <div class="w-full mb-4 flex flex-wrap justify-between">
        ...
        <Button class="h-8 w-full md:w-[50%] sm:max-w-[16rem]" label="Nueva Solicitud" icon="pi pi-plus" severity="success" as="router-link" to="/networks/shipment/new" />
      </div>
      <DataTable
